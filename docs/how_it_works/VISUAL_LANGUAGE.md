...
- `product.py`, `layers.py`, `journey.py`, `outcomes.py`, `database.py`, `project_export.py`, `review_loop.py`, and `brief.py` own the semantic inventory and authored composition of their diagrams.
