...
LAYER_DIRECTORIES: dict[str, str] = {
    ...
    "application": "Request purpose-specific facts and project accepted decisions into focused storage mutations.",
...
DIAGRAM = Diagram(
    ...
    boxes=(
        ...
        Box(
            ...
            ("purpose-specific reads · compact effects", "own storage capability ports"),
