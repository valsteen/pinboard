...
- **Application code** requests exact operation facts where supported, still reads complete stored state for remaining families, and projects an accepted decision into one targeted storage mutation.
