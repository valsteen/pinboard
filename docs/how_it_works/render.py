...
7. **Review the same decision.** A separate reviewer in the current coding agent compares that candidate with the same accepted brief and returns it for correction, accepts a checkpoint, or continues the attempt. The owning task then asks the human to choose repository disposition and confirm completion before the work becomes terminal.
