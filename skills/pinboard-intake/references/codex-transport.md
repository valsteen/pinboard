...
3. Send one compact notification containing the proposal ID, source task ID, shared work root, and the instruction to inspect it at the next safe boundary. Do not send commands or make the notified task responsible for unrelated outcomes.
